					...
					<table>
						...
						<?php include("../config.php");
							...
							else 
							{
                                ...
                                <td style="width:1000px;"><?php echo $gelen['ad']; ?></td>
                                <td style="width:1000px;"><?php echo $gelen['aciklama']; ?></td>
								<td style="width:1000px;"><?php echo $gelen['resim']; ?></td>
								<td style="width:1000px;"><?php echo $gelen['link']; ?></td>
								<td style="width:100px;" align="center"><a href="portprojeedit.php?id=<?php echo $gelen['id']; ?>"><img src="design/edit.png" alt="" title="Düzenle" /></a> &nbsp;&nbsp; <a href="plugin/portprojedel.php?id=<?php echo $gelen['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
								</tr>
						<?php }
							} ?>
