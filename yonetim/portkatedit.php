			...
			<div id="cols" class="box">
				...
				<div id="content" class="box">
					...
					<?php include("../config.php");
						...
						include("plugin/portkatsave.php");
						mysql_query("SET NAMES 'utf8'");
						mysql_query("SET CHARACTER SET utf8");
						mysql_query("SET COLLATION_CONNECTION = 'utf8_bin'");

						$sorgu = mysql_query("select * from portkat where id='$id'");
							...
							<form method="post">
								...
								<div class="col50">
									...
									<p class="t-justify">
										...
										<input type="text" size="40" name="kategori" value="<?php echo $gelen['kategori']; ?>" class="input-text" /><br><br>
