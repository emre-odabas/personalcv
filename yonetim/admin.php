			...
			<div id="cols" class="box">
				...
				<div id="aside" class="box">
					...
					<div class="padding box">
						...
						<p id="logo"><a href="home.php"><img src="design/logo.png" title="Sitesi Yönetim Paneli" alt="" /></a></p><br><br>
				...
				<div id="content" class="box">
					...
					<?php include("../config.php");
						include("plugin/adminsave.php");

						mysql_query("SET NAMES 'utf8'");
						mysql_query("SET CHARACTER SET utf8");
						mysql_query("SET COLLATION_CONNECTION = 'utf8_bin'");
						$sorgu = mysql_query("select * from administrator");
						while ($gelen = mysql_fetch_array($sorgu)) {  ?><br><br>
						<form method="post">
							<label><b>Kullanıcı Adı</b></label><br>
							<input type="text" size="40" name="username" value="<?php echo $gelen['username']; ?>" class="input-text" /><br><br>
