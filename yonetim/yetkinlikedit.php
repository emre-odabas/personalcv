        ...
        <div id="main">
            ...
            <div id="cols" class="box">
                ...
                <div id="content" class="box">
                    <h1>Yetkinlik Düzenle</h1>
                    <br>
                    <?php include("../config.php");

                        $id = $_GET['id'];

                        include("plugin/yetkinliksave.php");
                        mysql_query("SET NAMES 'utf8'");
                        mysql_query("SET CHARACTER SET utf8");
                        mysql_query("SET COLLATION_CONNECTION = 'utf8_bin'");

                        $sorgu = mysql_query("select * from yetkinlik where id='$id'");
                            ...
                            <form method="post">
                                ...
                                <div class="col50">
                                    ...
                                    <p class="t-justify">
                                        ...
                                        <input type="text" size="40" name="yetenek" value="<?php echo $gelen['yetenek']; ?>" class="input-text" placeholder="Ör. Java" /><br><br><br>

                                        <label><b>Derece</b></label><br>
                                        <input type="text" size="40" name="yuzde" value="<?php echo $gelen['yuzde']; ?>" class="input-text" placeholder="Ör. 50%" /><br><br><br>

                                        <label><b>Renk Kodu</b></label><br>
                                        <input type="text" size="40" name="renkkodu" value="<?php echo $gelen['renkkodu']; ?>" class="input-text" placeholder="Ör. #F63A00" /><br><br><br>
