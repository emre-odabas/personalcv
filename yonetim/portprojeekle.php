		...
		<div id="main">
			...
			<div id="cols" class="box">
				...
				<div id="content" class="box">
					<h1>Portfolyo Proje Ekle</h1>
					<br>
					<?php include("../config.php");
						include("plugin/portprojeadd.php"); ?>
					...
					<form method="post">
						...
						<div class="col50">
							...
							<p class="t-justify">
								...
								<input type="text" size="70" name="ad" class="input-text" /><br><br>

								<label><b>Resmi</b> (383x250) * (Not: Sadece resim adı ve uzantısını kopyala.)</label> <a onclick="window.open('../upload/upload.php','Upload','width=500,height=200,scrollbars=1');return false;" href="">Resim Yükle</a><br>
								<input type="text" size="70" name="resim" class="input-text" /><br><br>

								<label><b>Açıklama</b></label><br>
								<textarea name="aciklama" cols="50" rows="5"></textarea><br><br>

								<label><b>Link</b></label><br>
								<input type="text" size="70" name="link" class="input-text" value="#" /><br><br>
						...
						<input type="submit" class="input-submit" name="gonder" style="width:500px;" value="Ekle" />
					</form>
					<br>
				</div>
