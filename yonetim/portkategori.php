				...
				<div id="content" class="box">
					...
					<table>
						...
						<?php include("../config.php");
							...
							$sorgu = mysql_query("select * from portkat order by id asc");
							...
							else 
							{
								...
								<td style="width:1000px;"><?php echo $gelen['kategori']; ?></td>
								<td style="width:100px;" align="center"><a href="portkatedit.php?id=<?php echo $gelen['id']; ?>"><img src="design/edit.png" alt="" title="Düzenle" /></a> &nbsp;&nbsp; <a href="plugin/portkatdel.php?id=<?php echo $gelen['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
								</tr>
						<?php }
							} ?>
